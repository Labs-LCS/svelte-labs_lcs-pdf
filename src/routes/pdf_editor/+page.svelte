<script lang="ts">
	...
	import Header from '$lib/pdf_editor/components/Header.svelte';
	import Footer from '$lib/pdf_editor/components/Footer.svelte';
	import MainArea from '$lib/pdf_editor/components/MainArea.svelte';
